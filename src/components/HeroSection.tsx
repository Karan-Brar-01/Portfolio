  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span ref={line1Ref} className="flex flex-nowrap justify-center" style={{ overflow: "hidden" }}>
          ...
          <span ref={line2Ref} className="flex flex-nowrap justify-center" style={{ overflow: "hidden" }}>
