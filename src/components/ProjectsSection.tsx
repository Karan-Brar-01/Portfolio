...
export default function ProjectsSection() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-end justify-between pt-10 pb-6 w-full max-w-[1200px] mx-auto px-8">
        {/* Left: label + title */}
      ...
      >
        <div
          ...
          style={{ willChange: "transform", paddingLeft: "max(2rem, calc((100vw - 1200px) / 2 + 2rem))" }}
        >
          ...
          {/* End spacer */}
          <div className="flex-none" style={{ width: "max(2rem, calc((100vw - 1200px) / 2 + 2rem))" }} aria-hidden="true" />
        </div>
      </div>
